      ...
      calculatedValues && weibullPlotImage && powerCurvePlotImage && monthly_wind_energy && range_plot_wind && (
        <div className="py-8 px-4 mx-auto max-w-7xl" style={{ maxHeight: 'calc(113vh - 100px)', overflowY: 'scroll' }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8"> {/* Grid layout for medium devices and up */}
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden col-span-1">
                      ...
                      <div className="px-6 py-4">
                        ...
                        <div>
                          <span className="text-md font-medium text-gray-800">Effective Area:</span>
                          <span className="block font-semibold text-lg text-gray-800">{calculatedValues.effective_area} sq.m</span>
                        </div>
                      </div>
                    </div>

                    {/* Cost Details */}
                    <div className="bg-gray rounded-lg  overflow-hidden col-span-1">
                  ...
                  <div ref={contentRef} className="bg-white rounded-lg shadow-md overflow-hidden p-4 flex flex-col justify-between" style={{ height: '100%' }}>
                    <h3 className="text-3xl font-bold text-gray-800 mb-4 text-center ml-11">Graphical Analysis</h3>

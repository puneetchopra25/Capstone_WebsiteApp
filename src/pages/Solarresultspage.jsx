            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-3">
                ...
                <span className="block font-semibold text-lg text-gray-800">
                  {solarCalcValues.annual_energy_s} kWh
                </span>
              </div>
              ...
              <div className="mb-3">
                ...
                <span className="block font-semibold text-lg text-gray-800">
                  {solarCalcValues.capacity_factor_solar} %
                </span>
              </div>
              ...
              <div className="mb-3">
                ...
                <span className="block font-semibold text-lg text-gray-800">
                  {solarCalcValues.total_module_area} sq. m
                </span>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden col-span-1">
            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-3">
                ...
                <span className="block font-semibold text-lg text-gray-800">
                  $ {solarCalcValues.main_cost} / year
                </span>
              </div>
              ...
              <div>
                ...
                <span className="block font-semibold text-lg text-gray-800">
                  {solarCalcValues.payback_period} years
                </span>
              </div>
            </div>
          </div>
